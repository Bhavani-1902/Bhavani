...
public class Registration {
  ...
  @Test
  public void test() {
	  String path1="D:\\selenium\\chromedriver_win32\\chromedriver.exe";		System.setProperty("webdriver.chrome.driver", path1);
	 ...
	 String org="Portfolio Launches Registration page! ";
		...
		driver.findElement(By.id("email")).sendKeys("bhavani123@gmail.com");
		driver.findElement(By.id("phone number")).sendKeys("8008448651");
